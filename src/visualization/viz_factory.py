...
from src.visualization.core.registry import get_adapter_for_model, load_model
from src.visualization.plots.residuals import plot_residuals, plot_all_residuals
from src.visualization.plots.features import plot_feature_importance, plot_feature_importance_comparison
from src.visualization.plots.metrics import plot_metrics, plot_metrics_table, plot_model_comparison
from src.visualization.plots.sectors import plot_sector_performance, plot_sector_metrics_table, visualize_all_sector_plots
from src.visualization.plots.dataset_comparison import plot_dataset_comparison, create_all_dataset_comparisons
from src.visualization.plots.statistical_tests import plot_statistical_tests, visualize_statistical_tests
...
def create_comparative_dashboard(
    ...
    try:
        from src.visualization.plots.residuals import plot_residuals
        ax3 = axes[2]
        if model_list:
    ...
    try:
        from src.visualization.plots.metrics import plot_metrics_table
        ax4 = axes[3]
...
def create_cross_model_feature_importance_by_dataset(
    ...
    from src.visualization.core.model_family import ModelFamily, get_model_info
