...
from visualization_new.components.annotations import add_statistics_text, add_metrics_text
...
from visualization_new.utils.statistics import calculate_residual_statistics
