...
def update_main_imports():
    ...
    replacements = [
        ('from src.models.xgboost_model import', 'from src.models.xgboost_categorical import'),
        ('from src.models.lightgbm_model import', 'from src.models.lightgbm_categorical import'),
        ('from src.models.catboost_model import', 'from src.models.catboost_categorical import'),
    ]
