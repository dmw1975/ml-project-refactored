    ...
    for name, model_data in elasticnet_models.items():
        ...
        try:
            ...
            if hasattr(model, 'coef_'):
                ...
                # Plot with blue color to match other model plots
                # Using the standard color (#3498db) used for model visualizations
                sns.barplot(x='Importance', y='Feature', data=importance_df, ax=ax, color='#3498db')
